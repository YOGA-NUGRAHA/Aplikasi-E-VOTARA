...
<body class="bg-white flex flex-col items-center justify-center min-h-screen py-12">
    ...
    <div
        class="bg-white bg-opacity-90 shadow-2xl rounded-xl p-8 max-w-sm w-full <?php if(!$errors->any()): ?> slide-in-top <?php endif; ?>">
        <!-- Logo -->
        <div class="flex justify-center mb-6 mt-6">
            <img src="<?php echo e(asset('image/logo vote.png')); ?>" alt="Logo" class="w-20 h-20">
        </div>
    ...
    <?php if(session('success')): ?>
        <script>
            Swal.fire({
                title: "<?php echo e(session('success' , 'berhasil kweluadih')); ?>", 
                icon: 'success',
...
<?php /**PATH C:\laragon\www\pemilihan_osisfix\resources\views/login.blade.php ENDPATH**/ ?>
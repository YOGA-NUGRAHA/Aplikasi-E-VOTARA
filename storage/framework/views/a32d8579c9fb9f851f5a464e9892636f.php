...
<?php $component->withAttributes([]); ?>
    <div class="w-full  bg-white shadow-lg rounded-lg p-6">
        ...
        <div class="p-6 ">
            <form action="<?php echo e(url ('admin/TabelSiswa/'. $data->nisn)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <div class="mb-4">
                    <label for="nisn" class="block text-gray-700 font-semibold">NISN : <?php echo e($data->nisn); ?> </label>
                </div>
                <div class="mb-4">
                    <label for="nama" class="block text-gray-700 font-semibold">NAMA LENGKAP SISWA</label>
                    <input type="text" id="nama" name="nama" value="<?php echo e($data->nama); ?>"
...
<?php endif; ?><?php /**PATH C:\laragon\www\pemilihan_osisfix\resources\views/admin/TabelSiswa/edit.blade.php ENDPATH**/ ?>
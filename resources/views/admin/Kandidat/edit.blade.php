<x-sidebar-layout>
    <div class="w-full  bg-white shadow-lg rounded-lg p-6">
        <div class="bg-gray-900 text-white font-bold text-lg p-4 rounded-t-lg">
            Edit Calon Ketua Dan Wakil Osis
        </div>
        ...
        <div class="p-6 ">
            <form action="{{ url('Kandidat') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <select name="ketua" id="ketua" class="m w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 ">
                ...
                <div class="mb-4">
                    ...
                    <select name="wakil1" id="wakil1" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500">
                ...
                <div class="mb-4">
                    ...
                    <select name="wakil2" id="wakil2" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500">
                ...
                <div class="mb-4">
                    ...
                    <input type="file" class="form-control @error('image') is-invalid @enderror w-full border-gray-300 rounded-md" name="image">
